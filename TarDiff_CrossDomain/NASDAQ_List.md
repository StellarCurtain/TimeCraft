...
```bash
python ../TarDiff_CrossDomain/scripts/preprocess_nasdaq_for_tardiff.py --input_path ../TarDiff_CrossDomain/data/raw/NASDAQ --output_path ../TarDiff_CrossDomain/data/processed/nasdaq --seq_len 24 --pred_horizon 5
```
